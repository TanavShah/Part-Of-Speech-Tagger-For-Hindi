...
class Tagger:
    ...
    __train_file_name = "../../dataset/naive_bayes/train_set.csv"
    __test_file_name = "../../dataset/naive_bayes/test_set.csv"
    __tag_dict_file_name = "model.json"
    __tags_frequency_file_name = "../../analytics/tags_frequency.csv"
    __words_frequency_file_name = "../../analytics/words_frequency.csv"
